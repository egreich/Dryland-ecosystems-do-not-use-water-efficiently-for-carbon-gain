...
dataIN_T = read.csv("./clean_data/d_B_vcm.csv")
dataIN_WUE = read.csv("./clean_data/d_B_wue_vcm.csv")
...
get_SAM_inits(dataIN1, "vcm1")
get_SAM_inits(dataIN2, "vcm2")

### Run the model ###
SAM_WUE(dataIN1, "vcm1")
SAM_WUE(dataIN2, "vcm2")
